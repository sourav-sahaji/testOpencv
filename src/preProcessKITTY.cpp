...
int main()
{
    ...
    // Size of final image and crop roi for original image
//    cv::Rect cropRoi(243,0,750,370);
//    cv::Size finalSize(512,256);
    cv::Rect cropRoi(370,0,370,370);
    cv::Size finalSize(299,299);
//    cv::Rect cropRoi(243,0,740,370);
//    cv::Size finalSize(128,64);
...
//                        labelsFileProc << label << std::endl;
//                        labelsFileRaw << r << std::endl;

                        char inImgName[200];
                        std::sprintf(inImgName,"/home/sourav/dataset/KITTY/sequences/%02d/image_0/%06d.png",fileNum,i1);
...
//                        cv::Mat img2=imread(inImgName);
                        ...
                        img1 = img1(cropRoi).clone();
//                        img2 = img2(cropRoi).clone();
...
//                        cv::cvtColor(img2,img2,CV_BGR2GRAY);
                        ...
                        // Some resizing
                        cv::resize(img1,img1,finalSize);
//                        cv::resize(img2,img2,finalSize);

                        std::sprintf(inImgName,"../bin/train/img-%08d.jpg",gc);
